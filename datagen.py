...
class DataGenerator():
    ...
    def __init__(self, joints_name=None, img_dir=None, train_data_file=None, annotations_file=None, remove_joints=None):
        """
        Initializer
        Args:
        ...
        self.annotations_2d = self._get_mp5_2d_annotations()

    # --------------------Generator Initialization Methods ---------------------

    def _get_mp5_2d_annotations(self):
        annotation_ds = h5py.File(self.annotations_file, 'r')
        return annotation_ds["pose2d"][()]
